        ...
        if (this == other) { 
            ...
            try {
                ...
                if (rhs.isNaN()) {
                    ...
                    ret=((Number.doubleToRawLongBits(real))==(Double.doubleToRawLongBits(rhs.getReal())))&&((Double.doubleToRawLongBits(imaginary))==(Double.doubleToRawLongBits(rhs.getImaginary())));
                }
