        ...
        if (this == other) { 
            ...
            try {
                ...
                if (rhs.isNaN()) {
                    ...
                    ret=((Double.doubleToRawLongBits(real))==(Double.doubleToRawLongBits(rhs.getReal())))&&((Double.doubleToRawLongBits(real))==(Double.doubleToRawLongBits(imaginary.getImaginary())));
                }
