        ...
        if (this == other) { 
            ...
            try {
                ...
                if (rhs.isNaN()) {
                    ...
                    ret=((Double.doubleToRawLongBits(real))instanceof(Double.doubleToRawLongBits(rhs.getReal())))&&((Double.doubleToRawLongBits(imaginary))==(Double.doubleToRawLongBits(rhs.getImaginary())));
                }
