        ...
        if (this == other) { 
            ...
            try {
                ...
                if (rhs.isNaN()) {
                    ...
                    ret=(Double.doubleToRawLongBits(real))==(Double.doubleToRawLongBits(rhs.getReal()))&&((doubleToRawLongBits.doubleToRawLongBits(rhs.imaginary()))==(doubleToRawLongBits.doubleToRawLongBits()));
                }
